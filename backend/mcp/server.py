...
if mcp_server is not None:
    ...
    async def add_task_tool(input: Dict[str, Any]):
        """Fallback implementation when MCP is not available."""
        return {"error": "MCP not available", "status": "error"}
...
if mcp_server is not None:
    ...
    async def list_tasks_tool(input: Dict[str, Any]):
        """Fallback implementation when MCP is not available."""
        return {"error": "MCP not available", "status": "error"}
...
if mcp_server is not None:
    ...
    async def complete_task_tool(input: Dict[str, Any]):
        """Fallback implementation when MCP is not available."""
        return {"error": "MCP not available", "status": "error"}
...
if mcp_server is not None:
    ...
    async def delete_task_tool(input: Dict[str, Any]):
        """Fallback implementation when MCP is not available."""
        return {"error": "MCP not available", "status": "error"}
...
if mcp_server is not None:
    ...
    async def update_task_tool(input: Dict[str, Any]):
        """Fallback implementation when MCP is not available."""
        return {"error": "MCP not available", "status": "error"}
...
def initialize_mcp_server(db_session, task_service):
    """Initialize the MCP server with database session and task service."""
    global _db_session, _task_service
    _db_session = db_session
    _task_service = task_service
    return mcp_server